...
impl Manipulator6DOFSpec {
    pub const fn new(l1: f64, l2: f64, l3: f64, l4: f64, l5: f64, l6: f64, joint_limits: [JointLimits; 6]) -> Self {
        Self { l1, l2, l3, l4, l5, l6, joint_limits }
    }
    ...
    pub const fn joints(&self) -> [JointInfo; 6] {
        ...
        [
            ...
            JointInfo { name: "joint_5", kind: JointKind::Revolute, limits: Some(j5) },
            JointInfo { name: "joint_6", kind: JointKind::Revolute, limits: Some(j6) },
        ]
    }
}
