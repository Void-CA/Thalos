...
pub fn create_manipulator_3dof(
    ...
    let joint1 = JointType::Revolute(
        RevoluteJoint::new(0, UnitVector3::y_axis(), limits_j1, Transform3D::identity()),
    );
    let link1 = Link {
        id: 0,
    ...
    let joint2 = JointType::Revolute(
        RevoluteJoint::new(1, UnitVector3::z_axis(), limits_j2, Transform3D::identity()),
    );
    let link2 = Link {
        id: 1,
    ...
    let joint3 = JointType::Revolute(
        RevoluteJoint::new(2, UnitVector3::z_axis(), limits_j3, Transform3D::identity()),
    );
    let link3 = Link {
        id: 2,
