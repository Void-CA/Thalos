...
describe('SessionsWorkspace — renders the session browser (S5.5)', () => {
  it('mounts the browser shell and delegates to GET /sessions', async () => {
    apiMocks.list.mockResolvedValue([])
    renderWorkspace()

    // The redundant "Sessions" heading was removed (the Stepper labels the
    // stage); the browser's filter/search strip anchors the panel top.
